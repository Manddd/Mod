...
#include "GUI\MBR GUI Control Tab Smart Zap.au3"
	...
	$tabidx = GUICtrlRead($hGUI_MOD_TAB)
		Select
			Case $tabidx = 0 ; DocOc
				...
				GUISetState(@SW_HIDE, $hGUI_ModSmartZap)
			Case $tabidx = 1 ; Smart Zap
				GUISetState(@SW_SHOWNOACTIVATE, $hGUI_ModSmartZap)
