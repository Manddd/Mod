...
$sBotVersion = "v6.1.2.2" ;~ Don't add more here, but below. Version can't be longer than vX.y.z because it it also use on Checkversion()
$sBotTitle = "My Bot Mod " & $sBotVersion ;~ Don't use any non file name supported characters like \ / : * ? " < > |
